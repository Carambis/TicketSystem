...
public final class ConnectionPool {
    ...
    public void initConnectionPool() throws ConnectionPoolException {
        try {
            ...
            throw new ConnectionPoolException("SQL Exception", e);
    ...
    private class PooledConnection implements Connection {
        ...
        public void close() throws SQLException {
            if (connection.isClosed()) {
                throw new SQLException("Close closed connection");
            }
            if (connection.isReadOnly()) {
                connection.setReadOnly(false);
            }
            if (!givenAwayQueue.remove(this)) {
                throw new SQLException("Error deleting connection from pool given connection");
            }
            if (!connectionsQueue.offer(this)) {
                throw new SQLException("Error return connection in pool");
            }
        }
